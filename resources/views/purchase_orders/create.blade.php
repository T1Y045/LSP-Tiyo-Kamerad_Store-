...
<body class="dark-edition">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="createForm" method="POST" action="{{ route('purchase.store') }}">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="distributor_id" name="distributor_id" required>
                                                ...
                                                <option value="{{ $distributor->id }}" class="text-secondary">{{ $distributor->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row ms-3 me-3 justify-content-end">
                                            <div class="col-2">
                                                <a href="{{ route('purchase.index') }}" class="btn bg-secondary w-100">Cancel</a>
                                            </div>
                                            <div class="col-2">
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!distributorId.value.trim() || !totalAmount.value.trim() || !status.value.trim()) {
