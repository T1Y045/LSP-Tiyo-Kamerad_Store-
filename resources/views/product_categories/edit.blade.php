          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form id="editForm" method="POST" action="{{ route('product_categories.update', $category->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <a href="{{route('product_categories.index')}}" class="btn btn-sm bg-gradient-secondary">Cancel</a>
