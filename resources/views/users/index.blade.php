            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <a href="{{route('users.create')}}"><span class="card-category btn-sm btn btn-gradient-primary">+add new item</span></a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{ $data->aktif ? 'Active' : 'Not Active' }}
                          </td>
                          <td class="align-middle text-center text-sm">
                            <form action="{{ route('users.destroy', $data->id) }}" method="post" id="frmDelete{{ $data->id }}">
                            @csrf
                            @method('DELETE')
                            </form>
                            <a href="{{ route('users.edit', $data->id) }}" class="btn-sm btn btn-primary">Edit</a>
                            <a href="#" onclick="confirmDelete('{{ $data->name }}', {{ $data->id }})" class="btn-sm btn btn-gradient-danger">Delete</a>
                        </td>
                        </tr>
                        @endforeach
                      </tbody>
