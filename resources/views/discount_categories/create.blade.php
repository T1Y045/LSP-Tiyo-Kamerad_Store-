...
<body class="dark-edition">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      <!-- Navbar -->
      @section('page-title', 'Create Discount Category')
      @section('main')
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('discount_categories.store')}}" id="formpc" method='POST'>
                ...
                <div class="form-group mb-3 ms-3 me-3">
                    ...
                    <div class="row ms-3 me-3 justify-content-end">
                      <div class="col-2">
                        <a href="{{route('discount_categories.index')}}" class="btn btn-sm bg-gradient-secondary w-100">Cancel</a>
                      </div>
                      <div class="col-2">
